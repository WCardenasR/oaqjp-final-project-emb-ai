"""Module for emotion detection web application using Flask."""
...
def sent_emtion():
    """Receive text from the HTML interface and run emtion detection.
    
    The output returned shows the emotions for the provided text.
    """
